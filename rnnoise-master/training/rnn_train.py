...
plt.plot(history.history['loss'], label='训练集总损失')
plt.plot(history.history['val_loss'], label='验证集总损失')
plt.title('RNN模型的训练损失随训练轮次的变化')
plt.xlabel('Epoch')
plt.ylabel('Loss')
plt.legend()
plt.show()
...
plt.figure(figsize=(10, 6))
plt.plot(history.history['denoise_output_loss'], label='降噪模型训练集损失')
plt.plot(history.history['val_denoise_output_loss'], label='降噪模型验证集损失')
plt.title('降噪损失随训练轮次的变化')
plt.xlabel('Epoch')
plt.ylabel('Loss')
plt.legend()
plt.show()
