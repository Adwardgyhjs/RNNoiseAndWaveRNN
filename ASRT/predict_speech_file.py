...
def predict(file_path):
    ...
    ms.load_model('E:\\智能语音处理系统\\Noise-suppression-and-speech-recognition-systems-master\\ASRT\\save_models/' + sm251.get_model_name() + '.model.base.h5')
    print('save_models/' + sm251.get_model_name() + '.model.base.h5')
