...
class ModelLanguage(): # 语音模型类
    ...
    def GetLanguageModel(self, modelLanFilename):
        ...
        返回读取后的模型
        '''
        modelLanFilename="E:/智能语音处理系统/Noise-suppression-and-speech-recognition-systems-master/ASRT/model_language/language_model1.txt"
    ...
    def GetPinyin(self, filename):
        filename="E:/智能语音处理系统/Noise-suppression-and-speech-recognition-systems-master/ASRT/model_language/dic_pinyin.txt"
